...
INSERT INTO websites (user_id, web_url, description)
VALUES (1, 'https://warb.onrender.com/', '- Full-featured RESTful Twitter clone, implementing full CRUD and 12-bit hashed-based user authentication, and implemented using test-driven development using Python/Flask, bcrypt, Jinja2, and SQLAlchemy.
...
(1, 'jobly-mjokipro-li.surge.sh', '- Full-featured RESTful LinkedIn clone, implementing full CRUD, 12-bit hashed-based user authentication, and designed using test-driven development in Node/Express.js, ReactJS, and SQL.
...
(1, 'https://mjokipro--redcube.surge.sh/login', '- Have a look at the newest selection of downloadable content now available on Redcube! This is essentially a Netflix clone that demonstrates real-world business applications. 
...
(1, 'https://edify-python.onrender.com', '- The main drive behind this project was a yearning to serve the Lord Jesus Christ, and it attempts to show the skill that He has blessed me with.  It is only a model, and it was developed using Python and Jinja2 templating.  
