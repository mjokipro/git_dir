...
DROP DATABASE blogly_ca_test;
CREATE DATABASE blogly_ca_test;
\connect blogly_ca_test
...
CREATE TABLE messages (
    id SERIAL PRIMARY KEY,
    from_user INTEGER REFERENCES users ON DELETE CASCADE,
    to_user INTEGER REFERENCES users ON DELETE CASCADE,
    body TEXT NOT NULL
